...
namespace WindowsPhoneGame1.GameScreens
{
    public class BattleScreen: BaseGameState
    {
        ...
        LinkLabel options;
        LinkLabel exitGame;
        SoundEffect fightsound;
        SoundEffect battlehorn;
        ...
        protected override void LoadContent()
        {
            ...
            backgroundImage = new PictureBox(
                Content.Load<Texture2D>(@"Backgrounds\"+map), 
                GameRef.ScreenRectangle);
            ControlManager.Add(backgroundImage);

            fightsound = Content.Load<SoundEffect>(@"Sounds\fight");
            fightsound.Play();

            battlehorn = Content.Load<SoundEffect>(@"Sounds\airhorn");
            battlehorn.Play();
